...
package compiler.testframework.tests;

import compiler.testframework.*;
...
class MultipleFailOnBad {
    ...
    @Test
    @IR(failOn = {IRNode.STORE_OF_CLASS, "compiler/testframework/tests/MultipleFailOnBad", IRNode.CALL, IRNode.ALLOC})
    public void fail4() {
        iFld = 42;
    }
    ...
    @Test
    @IR(failOn = {IRNode.STORE_OF_CLASS, "UnknownClass", IRNode.ALLOC_OF, "compiler/testframework/tests/MyClassSub"})
    public void fail8() {
...
class GoodCount {
    ...
    @IR(counts = {IRNode.STORE, "2", IRNode.STORE_I, "1", IRNode.STORE_L, "1",
                  ...
                  IRNode.STORE_OF_CLASS, "compiler/testframework/tests/MyClass", "1",
                  IRNode.STORE_I_OF_CLASS, "compiler/testframework/tests/MyClass", "1",
...
class AllocArray {
    ...
    @IR(failOn = {IRNode.ALLOC_ARRAY_OF, "compiler/testframework/tests/MyClass"})
...
class Loads {
    ...
    @IR(failOn = {IRNode.LOAD_OF_CLASS, "compiler/testframework/tests/Loads"})
