...
public class IRNode {
    ...
    public static final String STORE_B = START + "StoreB" + MID + END;
    ...
    public static final String LOAD_C = START + "LoadC" + MID + END;
    ...
    public static final String LOAD_C_OF_CLASS = START + "LoadC" + MID + "@\\S*";
    ...
    static List<String> mergeNodes(String[] nodes) {
        ...
        for (int i = 0; i < nodes.length; i += 2) {
            ...
            switch (node) {
                ...
                case STORE_OF_CLASS, STORE_B_OF_CLASS, STORE_C_OF_CLASS, STORE_D_OF_CLASS, STORE_F_OF_CLASS, STORE_I_OF_CLASS, STORE_L_OF_CLASS,
                        STORE_N_OF_CLASS, STORE_P_OF_CLASS -> mergeCompositeNodes(nodes, mergedNodes, i, node, STORE_OF_CLASS_POSTFIX, "STORE_OF_CLASS");
