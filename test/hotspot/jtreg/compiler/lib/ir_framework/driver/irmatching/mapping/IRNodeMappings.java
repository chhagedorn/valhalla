...
import compiler.valhalla.inlinetypes.InlineTypeRegexes;
...
public class IRNodeMappings {
    ...
    private void addInlineTypeMappings() {
        optoOnly(InlineTypeIRNode.ALLOC_G, InlineTypeRegexes.ALLOC_G);
        optoOnly(InlineTypeIRNode.ALLOCA_G, InlineTypeRegexes.ALLOCA_G);
        optoOnly(InlineTypeIRNode.MYVALUE_ARRAY_KLASS, InlineTypeRegexes.MYVALUE_ARRAY_KLASS);
        optoOnly(InlineTypeIRNode.ALLOC, InlineTypeRegexes.ALLOC);
        optoOnly(InlineTypeIRNode.ALLOCA, InlineTypeRegexes.ALLOCA);
        idealIndependentOnly(InlineTypeIRNode.LOAD, InlineTypeRegexes.LOAD);
        idealIndependentOnly(InlineTypeIRNode.LOADK, InlineTypeRegexes.LOADK);
        idealIndependentOnly(InlineTypeIRNode.STORE, InlineTypeRegexes.STORE);
        idealIndependentOnly(InlineTypeIRNode.LOOP, InlineTypeRegexes.LOOP);
        idealIndependentOnly(InlineTypeIRNode.COUNTEDLOOP, InlineTypeRegexes.COUNTEDLOOP);
        idealIndependentOnly(InlineTypeIRNode.COUNTEDLOOP_MAIN, InlineTypeRegexes.COUNTEDLOOP_MAIN);
        idealIndependentOnly(InlineTypeIRNode.TRAP, InlineTypeRegexes.TRAP);
        idealIndependentOnly(InlineTypeIRNode.LINKTOSTATIC, InlineTypeRegexes.LINKTOSTATIC);
        idealIndependentOnly(InlineTypeIRNode.NPE, InlineTypeRegexes.NPE);
        idealIndependentOnly(InlineTypeIRNode.CALL, InlineTypeRegexes.CALL);
        optoOnly(InlineTypeIRNode.CALL_LEAF, InlineTypeRegexes.CALL_LEAF);
        optoOnly(InlineTypeIRNode.CALL_LEAF_NOFP, InlineTypeRegexes.CALL_LEAF_NOFP);
        idealIndependentOnly(InlineTypeIRNode.STORE_INLINE_FIELDS, InlineTypeRegexes.STORE_INLINE_FIELDS);
        optoOnly(InlineTypeIRNode.SCOBJ, InlineTypeRegexes.SCOBJ);
        idealIndependentOnly(InlineTypeIRNode.LOAD_UNKNOWN_INLINE, InlineTypeRegexes.LOAD_UNKNOWN_INLINE);
        optoOnly(InlineTypeIRNode.STORE_UNKNOWN_INLINE, InlineTypeRegexes.STORE_UNKNOWN_INLINE);
        optoOnly(InlineTypeIRNode.INLINE_ARRAY_NULL_GUARD, InlineTypeRegexes.INLINE_ARRAY_NULL_GUARD);
        optoOnly(InlineTypeIRNode.INTRINSIC_SLOW_PATH, InlineTypeRegexes.INTRINSIC_SLOW_PATH);
        optoOnly(InlineTypeIRNode.CLONE_INTRINSIC_SLOW_PATH, InlineTypeRegexes.CLONE_INTRINSIC_SLOW_PATH);
        idealIndependentOnly(InlineTypeIRNode.CLASS_CHECK_TRAP, InlineTypeRegexes.CLASS_CHECK_TRAP);
        idealIndependentOnly(InlineTypeIRNode.NULL_CHECK_TRAP, InlineTypeRegexes.NULL_CHECK_TRAP);
        idealIndependentOnly(InlineTypeIRNode.NULL_ASSERT_TRAP, InlineTypeRegexes.NULL_ASSERT_TRAP);
        idealIndependentOnly(InlineTypeIRNode.RANGE_CHECK_TRAP, InlineTypeRegexes.RANGE_CHECK_TRAP);
        idealIndependentOnly(InlineTypeIRNode.UNHANDLED_TRAP, InlineTypeRegexes.UNHANDLED_TRAP);
        idealIndependentOnly(InlineTypeIRNode.PREDICATE_TRAP, InlineTypeRegexes.PREDICATE_TRAP);
        idealIndependentOnly(InlineTypeIRNode.MEMBAR, InlineTypeRegexes.MEMBAR);
        optoOnly(InlineTypeIRNode.CHECKCAST_ARRAY, InlineTypeRegexes.CHECKCAST_ARRAY);
        optoOnly(InlineTypeIRNode.CHECKCAST_ARRAYCOPY, InlineTypeRegexes.CHECKCAST_ARRAYCOPY);
        optoOnly(InlineTypeIRNode.JLONG_ARRAYCOPY, InlineTypeRegexes.JLONG_ARRAYCOPY);
        optoOnly(InlineTypeIRNode.FIELD_ACCESS, InlineTypeRegexes.FIELD_ACCESS);
        idealIndependentOnly(InlineTypeIRNode.SUBSTITUTABILITY_TEST, InlineTypeRegexes.SUBSTITUTABILITY_TEST);
        idealIndependentOnly(InlineTypeIRNode.CMPP, InlineTypeRegexes.CMPP);
    }
}
