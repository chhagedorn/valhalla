...
public final primitive class MyValue1 extends MyAbstract {
    static int s;
    static final long sf = MyConstants.rL;
    final int x;
    final long y;
    final short z;
    final Integer o;
    ...
    final MyValue2 v1;
    final MyValue2 v2;
    static final MyValue2 v3 = MyValue2.createWithFieldsInline(MyConstants.rI, MyConstants.rD);
    final int c;
    ...
    static MyValue1 createWithFieldsInline(int x, long y) {
        ...
        int[] oa = {x};
        v = setOA(v, oa);
        v = setV1(v, MyValue2.createWithFieldsInline(x, y, MyConstants.rD));
        v = setV2(v, MyValue2.createWithFieldsInline(x, y, MyConstants.rD + x));
        v = setC(v, (int)(x+y));
        return v;
    }
