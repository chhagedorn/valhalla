...
class MultipleFailOnBad {
    ...
    @Test
    @IR(failOn = {IRNode.STORE_OF_CLASS, "testframework/tests/MultipleFailOnBad", IRNode.CALL, IRNode.ALLOC})
    public void fail4() {
        iFld = 42;
    }
    ...
    @Test
    @IR(failOn = {IRNode.STORE_OF_CLASS, "UnknownClass", IRNode.ALLOC_OF, "testframework/tests/MyClassSub"})
    public void fail8() {
...
class GoodCount {
    ...
    @IR(counts = {IRNode.STORE, "2", IRNode.STORE_I, "1", IRNode.STORE_L, "1",
                  ...
                  IRNode.STORE_OF_CLASS, "testframework/tests/MyClass", "1",
                  IRNode.STORE_I_OF_CLASS, "testframework/tests/MyClass", "1",
...
class AllocArray {
    ...
    @IR(failOn = {IRNode.ALLOC_ARRAY_OF, "testframework/tests/MySubClass"}) // Does not fail
    @IR(failOn = {IRNode.ALLOC_ARRAY_OF, "testframework/tests/MyClass"})
...
class Loads {
    ...
    @IR(failOn = {IRNode.LOAD_OF_CLASS, "testframework/tests/Loads"})
